...
import com.coderlyfe.OrderService.OrderServiceConfig;
...
public class OrderControllerTest {
    ...
    public void test_WhenPlaceOrder_DoPayment_Success() throws Exception {
        ...
        //get order by Order ID from DB and check output
    ...
    @Test
    public void test_WhenPlaceOrderWithWrongAccess_thenThrow404() throws Exception {
        OrderRequest orderRequest = getMockOrderRequest();
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/order/placeOrder")
