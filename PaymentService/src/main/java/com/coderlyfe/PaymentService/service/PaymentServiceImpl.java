...
import com.coderlyfe.PaymentService.model.PaymentMode;
import com.coderlyfe.PaymentService.model.PaymentRequest;
import com.coderlyfe.PaymentService.model.PaymentResponse;
import com.coderlyfe.PaymentService.repository.TransactionDetailsRepository;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    public PaymentResponse getPaymentDetailsByOrderId(String orderId) {
        log.info("Getting payment order details for orderID {}", orderId);
